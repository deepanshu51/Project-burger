    ...
    ₹{order.totalAmount}
     ...
     <article>
       ...
       <div>
        <h4>Ham Burger</h4>
        <div>
            <span>{order.orderItems.hamBurger.quantity}</span> x <span>{order.orderItems.hamBurger.price}</span>
        </div>
       </div>
       ...
       <div>
        <h4>Creamy Burger</h4>
        <div>
            <span>{order.orderItems.creamyBurger.quantity}</span> x <span>{order.orderItems.creamyBurger.price}</span>
        </div>
       </div>
       <div>
        <h4 style={{
